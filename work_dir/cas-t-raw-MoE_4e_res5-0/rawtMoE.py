...
data_root = '/home/dhw/yyc_workspace/ConvNeXt-MoE/yolo_splited/'
...
default_hooks = dict(
    ...
    visualization=dict(draw=True, show=True, type='DetVisualizationHook'))
default_scope = 'mmdet'
env_cfg = dict(
...
model = dict(
    backbone=dict(
        ...
        router_reduction_ratio=8,
        top_k=2,
        type='mmpretrain.ConvNeXtMoE'),
...
test_evaluator = dict(
    ann_file='/home/dhw/yyc_workspace/ConvNeXt-MoE/yolo_splited/anno_val.json',
    backend_args=None,
    classwise=True,
    format_only=False,
    metric='bbox',
...
work_dir = 'work_dir/cas-t-raw-MoE'
