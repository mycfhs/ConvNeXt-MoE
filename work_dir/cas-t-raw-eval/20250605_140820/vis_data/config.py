...
launcher = 'none'
load_from = 'work_dir/cas-t-raw/epoch_36.pth'
log_level = 'INFO'
...
test_evaluator = dict(
    ann_file='/home/dhw/yyc_workspace/ConvNeXt-MoE/dataset_coco/anno_test.json',
    backend_args=None,
    classwise=True,
    format_only=False,
    metric='bbox',
...
work_dir = 'work_dir/cas-t-raw-eval'
